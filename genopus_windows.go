...
//sys opus_decode(p unsafe.Pointer, data []byte, out []int16)(n int) = opus.opus_decode
//sys opus_decode_float(p unsafe.Pointer, data []byte, out []float32)(n int) = opus.opus_decode_float
...
//sys opus_encode(p unsafe.Pointer, pcm []int16, out []byte)(n int) = opus.opus_encode
//sys opus_encode_float(p unsafe.Pointer, pcm []float32, out []byte)(n int) = opus.opus_encode_float
